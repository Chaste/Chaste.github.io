...
The following are legacy instructions for creating paper tutorial wiki pages, prior to the migration of paper tutorials to the current website.
{{< /callout >}}

The steps to create '[paper tutorial](..)' wiki pages associated with a new or forthcoming publication are as follows.
For an example see the [source for the project Plos2013](https://github.com/Chaste/project_Plos2013), which gets rendered as shown at [PaperTutorials/Plos2013](../plos2013).
...
For the definitive guide, see the [CreateTutorial.py script](https://github.com/Chaste/Chaste/blob/develop/python/utils/CreateTutorial.py). The main features are:
