---
title : "Running Mesh Based Crypt Simulations"
summary: "Examples showing how to run crypt simulations on periodic meshes with different cell-cycle models"
draft: false
images: []
toc: true
---
This tutorial is automatically generated from [TestRunningMeshBasedCryptSimulationsTutorial.hpp](https://github.com/Chaste/Chaste/blob/develop/crypt/test/tutorial/TestRunningMeshBasedCryptSimulationsTutorial.hpp) at revision [86da82f2455f](https://github.com/Chaste/Chaste/commit/86da82f2455f25c9cd8530546419e71b65cf716e). Note that the code is given in full at the bottom of the page.
