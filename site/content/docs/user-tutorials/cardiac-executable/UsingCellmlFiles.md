...
which for convenience can be placed at the end of the CellML file.  See ["ChasteGuides/CodeGenerationFromCellML"] for full details of the functionality available.  The [[ChasteGuides/TroubleShooting#chaste_codegenErrors|chaste_codegen section of the [TroubleShooting](https://github.com/Chaste/trac_archive/wiki/Trouble-Shooting) page]] may be useful if you experience problems.
