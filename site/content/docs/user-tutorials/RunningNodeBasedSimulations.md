---
title : "Running Node Based Simulations"
summary: "Examples showing how to create, run and visualize node-based simulations"
draft: false
images: []
toc: true
---
This tutorial is automatically generated from [TestRunningNodeBasedSimulationsTutorial.hpp](https://github.com/Chaste/Chaste/blob/develop/cell_based/test/tutorial/TestRunningNodeBasedSimulationsTutorial.hpp) at revision [86da82f2455f](https://github.com/Chaste/Chaste/commit/86da82f2455f25c9cd8530546419e71b65cf716e). Note that the code is given in full at the bottom of the page.
