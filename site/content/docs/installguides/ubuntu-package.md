...
The package has been tested with all versions of Ubuntu from **Intrepid (8.10)** to **Oracular (24.10)** inclusive, and will be adapted to new versions as soon as possible after they are released.
...
{{< details "Ubuntu 26.04 LTS" open >}}
```text
deb [signed-by=/usr/share/keyrings/chaste.asc] https://chaste.github.io/ubuntu resolute/
```
{{< /details >}}

{{< details "Ubuntu 25.10" >}}
```text
deb [signed-by=/usr/share/keyrings/chaste.asc] https://chaste.github.io/ubuntu questing/
```
{{< /details >}}

{{< details "Ubuntu 25.04" >}}
```text
deb [signed-by=/usr/share/keyrings/chaste.asc] https://chaste.github.io/ubuntu plucky/
```
{{< /details >}}

{{< details "Ubuntu 24.10" >}}
```text
deb [signed-by=/usr/share/keyrings/chaste.asc] https://chaste.github.io/ubuntu oracular/
```
{{< /details >}}

{{< details "Ubuntu 24.04 LTS" >}}
```text
