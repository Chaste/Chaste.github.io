...
The steps required to reproduce the study are:
 ...
 1. Run a simulation of a 3D lesion, with varying command line parameters ([C++ file for performing simulation](https://github.com/Chaste/trac_archive/wiki/._Fibroblasts3d))
