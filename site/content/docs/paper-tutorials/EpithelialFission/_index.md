---
title: "Investigation of Buckling and Fission in an Epithelial Layer"
draft: false
layout: "single"
showPageLinks: true
paperTutorialProject: "https://github.com/Chaste/project_EpithelialFission"
---
...
This model is an extension on a model originally presented in Langlands et al. (2017) [doi: 10.1371/journal.pbio.1002491](http://dx.doi.org/10.1371/journal.pbio.1002491).
The code to run single simulations can be found at the [Paper Tutorial](cryptfissionsweeps) for that paper.
...
You will also need the source for the [EpithelialFission](https://github.com/Chaste/project_EpithelialFission) project.  This can be done by checking out the version from the repository by using the command

```bash
git clone https://github.com/Chaste/project_EpithelialFission.git
```
...
There are two folders - `src` and `test`.
 ...
 2. The `test` folder contains:
    ...
    * [TestCryptFissionSweepsLiteratePaper.hpp](https://github.com/Chaste/project_EpithelialFission/blob/1128d5099e47092753771cff49645ed7afea62fa/test/TestCryptFissionSweepsLiteratePaper.hpp) - this file can be run to generate the results in Figures 6-11.
