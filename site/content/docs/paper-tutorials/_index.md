...
* [Rubinacci et al. CoGNaC: A Chaste Plugin for the Multiscale Simulation of Gene Regulatory Networks Driving the Spatial Dynamics of Tissues and Cancer, Cancer Informatics, 2015](https://github.com/Chaste/trac_archive/wiki/Paper-Tutorials-_-Co-G-Na-C).
* [Samanta et al. Ca2+ Channel Re-localization to Plasma-Membrane Microdomains Strengthens Activation of Ca2+-Dependent Nuclear Gene Expression, Cell Reports, 2015](https://github.com/Chaste/trac_archive/wiki/Paper-Tutorials-_-Ca-Diffusion).
* [Capel et al. Hydroxychloroquine reduces heart rate by modulating the hyperpolarisation-activated current 'If': Novel electrophysiological insights and therapeutic potential, Heart Rhythm, 2015](https://github.com/Chaste/trac_archive/wiki/Paper-Tutorials_HR2015).
...
* [Britton et al. Experimentally calibrated population of models predicts and explains inter-subject variability in cardiac cellular electrophysiology. PNAS, 2013](https://github.com/Chaste/trac_archive/wiki/Paper-Tutorials_PNAS-_-Population-Of-Models).
* [Walmsley et al. mRNA Expression Levels Predict Cellular Electrophysiological Remodeling in Failing Human Hearts: A Population-Based Simulation Study. PLoS ONE, 2013](https://github.com/Chaste/trac_archive/wiki/Paper-Tutorials-_-Plos-One_m-RNA).
* [Cooper and Osborne. Connecting models to data in multiscale multicellular tissue simulations. International Conference on Computational Science, 2013](https://github.com/Chaste/trac_archive/wiki/Paper-Tutorials-_-Wisc2013).
...
For instructions on how to create a new paper tutorial, see [WritingPaperTutorials](https://github.com/Chaste/trac_archive/wiki/Paper-Tutorials-_-Writing-Paper-Tutorials).

This list is ordered such that the most recently edited page is first.
[SubWiki(,1,,2,1)](SubWiki(,1,,2,1))
