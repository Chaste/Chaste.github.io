...
* **Linux**: Chaste is primarily developed on [Ubuntu Linux](https://www.ubuntu.com/) (recommended), and is regularly tested on all Long Term Support (LTS) versions of Ubuntu, but should also work on other Linux/Unix systems.
...
1. Download a fixed release of Chaste, found on the [releases page](https://github.com/Chaste/Chaste/releases).
2. Clone the latest `release` branch (to stay up to date with 6-monthly releases) using [git](https://git-scm.com/).
3. Stay right up to date with latest developments using our other git [tested development branches](https://github.com/Chaste/Chaste/branches).
...
Perusing the [release notes](https://github.com/Chaste/trac_archive/wiki/ReleaseNotes) and [latest news](/latest-news/) can give you a good overview of what features are in each release, and what has been added since.
...
Otherwise you should use the [InstallGuide](/docs/InstallGuides/InstallGuide) and follow the instructions on installing dependencies (or use the installation guide supplied with the release).

In addition to software dependencies, if you wish to do programming yourself, then we recommend using a C++ integrated development environment such as [VSCode](https://code.visualstudio.com/), [Eclipse](http://www.eclipse.org/cdt/) or [Clion](https://www.jetbrains.com/clion/).
...
For general discussion about Chaste, and questions regarding usage, we provide the [Chaste users' mailing list](mailto:chaste-users@maillist.ox.ac.uk).
You can subscribe to the list by [following these instructions](https://web.maillist.ox.ac.uk/ox/subscribe/chaste-users).
Public [list archives](https://web.maillist.ox.ac.uk/ox/arc/chaste-users) are available.

Bug reports and feature requests may be submitted by opening an [issue](https://github.com/Chaste/Chaste/issues) on GitHub.
