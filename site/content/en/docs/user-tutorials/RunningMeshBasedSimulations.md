...
---
title : "Running Mesh Based Simulations Tutorial"
summary: "This tutorial is automatically generated from the file cell_based/test/tutorial/TestRunningMeshBasedSimulationsTutorial.hpp at revision [c64c70046e25](https://github.com/Chaste/Chaste/commit/c64c70046e25e3f67b47ec3e92f29cb02d5e6830). Note that the code is given in full at the bottom of the page."
draft: false
images: []
toc: true
---
...
and the dimension.
For a list of possible cell cycle models see subclasses of `AbstractCellCycleModel`{.cpp}.
...
`p_force->SetCutOffLength(1.5);`{.cpp}
on the `GeneralisedLinearSpringForce`{.cpp}. Here there will be no forces exerted
...
cell population called a `MeshBasedCellPopulationWithGhostNodes`{.cpp}. The third
