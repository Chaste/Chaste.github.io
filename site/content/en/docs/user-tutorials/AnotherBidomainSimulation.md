...
---
title : "TestAnotherBidomainSimulationTutorial.hpp"
description: "This tutorial is automatically generated from the file heart/test/tutorials/TestAnotherBidomainSimulationTutorial.hpp at revision [dc0fc851da33](https://github.com/Chaste/Chaste/commit/dc0fc851da33d398a30adf6f0a3033ba159c438b). Note that the code is given in full at the bottom of the page."
draft: false
images: []
toc: true
---
...
`DistributedVector`{.cpp} class, which can be used to only iterate over the values
